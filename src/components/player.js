...
let sound =document.querySelector('.audio_feed');
...
class Player extends Component {
	...
	componentDidMount() {
		sound = document.querySelector('.audio_feed');
				...
				<div>
					<div>
						<svg onClick={this.play_audio} className="ear_svg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
							...
							<path fill="#ffffff" d="M17,20c-0.29,0-0.561-0.061-0.76-0.15c-0.711-0.369-1.211-0.879-1.711-2.379c-0.51-1.561-1.469-2.291-2.389-3
